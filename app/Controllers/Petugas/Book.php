...
class Book extends BaseController
{
    public function index()
    {
        ...
        $breadcrumb = [
            ['label' => 'Dashboard', 'url' => base_url('petugas/dashboard')],
            ['label' => 'Manajemen Buku', 'url' => '']
        ];

        return view('petugas/books/index', [
            'books'      => $booksList,
    ...
    public function add()
    {
        ...
        $breadcrumb = [
            ['label' => 'Dashboard', 'url' => base_url('petugas/dashboard')],
            ['label' => 'Manajemen Buku', 'url' => base_url('petugas/books')],
            ['label' => 'Tambah Buku', 'url' => '']
        ];
        return view('petugas/books/form', [
            'categories' => $categoryModel->orderBy('nama','ASC')->findAll(),
            'breadcrumb' => $breadcrumb,
            'book'       => null,
            'form_action'=> base_url('petugas/books/save')
        ]);
    }
    ...
    public function save()
    {
        ...
        return redirect()->to(base_url('petugas/books'))->with('success', 'Buku berhasil ditambahkan!');
    }
    ...
    public function edit($id)
    {
        ...
        return view('petugas/books/form', [
            ...
            'breadcrumb' => $breadcrumb,
            'book'       => $book,
            'form_action'=> base_url('petugas/books/update/'.$id)
        ]);
    }
    ...
    public function update($id)
    {
        ...
        return redirect()->to(base_url('petugas/books'))->with('success', 'Buku berhasil diupdate!');
    }

    // Tidak ada fungsi delete!

    // AJAX tambah kategori dari form buku (jika petugas diizinkan)
