...
// Route untuk search otomatis
$searchAction = '';
switch ($segment2) {
    case 'users':
        $searchAction = base_url('admin/users/admin');
        break;
    case 'books':
        $searchAction = base_url('admin/books');
        break;
    case 'peminjaman':
        $searchAction = base_url('admin/peminjaman');
        break;
    case 'laporan':
        $searchAction = base_url('admin/laporan');
        break;
    default:
        $searchAction = '#';
}
    ...
    <nav>
      ...
      <ol class="flex flex-wrap pt-1 mr-12 bg-transparent rounded-lg sm:mr-16">
        <li class="text-sm leading-normal">
          <a class="opacity-50 text-slate-700" href="<?= base_url('admin/dashboard') ?>">Dashboard</a>
        </li>
        <?php if ($segment2): ?>
